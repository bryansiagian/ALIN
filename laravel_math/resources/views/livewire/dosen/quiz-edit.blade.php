<div>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-semibold text-slate-900 mt-2">Edit Kuis</h1>
    </div>
                    ...
                    <div>
                        ...
                        @elseif ($question['existing_image'])
                            <div class="relative inline-block mt-2">
                                <img src="{{ $question['existing_image'] }}" class="h-24 rounded-lg border border-slate-200">
                                <button type="button" wire:click="removeQuestionImage({{ $qIndex }})" class="absolute -top-2 -right-2 bg-red-600 text-white rounded-full w-5 h-5 text-xs leading-none">×</button>
                            </div>
                        @endif
                                ...
                                <div class="flex-1 space-y-2">
                                    ...
                                    @elseif ($option['existing_image'])
                                        <div class="relative inline-block">
                                            ...
                                            <button type="button" wire:click="removeOptionImage({{ $qIndex }}, {{ $oIndex }})" class="absolute -top-2 -right-2 bg-red-600 text-white rounded-full w-5 h-5 text-xs leading-none">×</button>
                                        </div>
                                    @endif
                                </div>
                            </div>
