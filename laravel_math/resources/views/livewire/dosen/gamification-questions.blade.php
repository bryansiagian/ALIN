<div>
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="font-['Space_Grotesk'] text-2xl font-bold" style="color:#0F2D6B;">Soal Latihan (Gamifikasi)</h1>
        <p class="text-sm mt-1" style="color:#7C8DB5;">Kelola soal latihan/level yang sudah diimport.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-4 mb-4 grid grid-cols-1 md:grid-cols-4 gap-3 items-end"
        ...
        <div>
            ...
            <select wire:model.live="topic_filter"
                class="w-full rounded-xl border pl-3.5 pr-3.5 py-2.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2"
                style="background:#F0F6FF; border-color:#D0E2FF; color:#0F2D6B; --tw-ring-color:#4B8EFF33;">
            ...
            <tbody>
                @forelse ($questions as $q)
                    <tr style="border-top:1px solid #F0F4FC;">
                        ...
                        <td class="px-5 py-3.5" style="color:#435273;">{{ $q->topic->title ?? '-' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-5 py-12 text-center text-sm" style="color:#A9B6D6;">
