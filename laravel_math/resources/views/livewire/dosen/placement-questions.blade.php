<div>
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-slate-900">Soal Placement Test</h1>
        <p class="text-slate-500 text-sm mt-1">Kelola soal placement test yang sudah diimport.</p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 p-4 mb-4 grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
        <div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-5 py-8 text-center text-slate-400 text-sm">Belum ada soal placement.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
